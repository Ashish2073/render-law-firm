...
@section('lawyer-auth-section')
    ...
    <div class="w-full max-w-md p-4 fade-in">
        <div class="bg-white shadow-lg rounded-lg px-8 pt-8 pb-8 mb-4">
            ...
            <h1 class="text-2xl text-center text-gray-700 font-bold mb-6">Lawyer Login</h1>
            ...
            <form action="{{ route('lawyer.login') }}" method="POST">
                ...
                <div class="text-center">
                    <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800 transition duration-200" href="{{url('lawyer/registration')}}">
