    ...
    <div class="card-body">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mt-2 text-md-end">
                <button id="assignButton" class="btn btn-primary me-2" onclick="lawyerAssignToPlaintiff()">Assign</button>
                <button id="dissociateButton" class="btn btn-danger" onclick="lawyerDissociateToPlaintiff()">Dissociate</button>
            </div>
        </div>
    </div>
</div>
